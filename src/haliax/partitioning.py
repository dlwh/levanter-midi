...
from jax.sharding import PartitionSpec, Mesh, SingleDeviceSharding, NamedSharding
...
def physical_axis_name(axis: Axis, mapping: Optional[ResourceMapping] = None) -> Optional[PhysicalAxisSpec]:
...
def sharding_for_axis(
    axis: AxisSpec, mapping: Optional[ResourceMapping] = None, mesh: Optional[Mesh] = None
) -> NamedSharding:
